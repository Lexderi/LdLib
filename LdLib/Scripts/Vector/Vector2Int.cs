...
namespace LdLib.Vector
{
    public struct Vector2Int
    {
        ...
        public Vector2Int(int xy) => this = new(xy, xy);
        ...
        public static Vector2Int operator *(Vector2Int v, float scalar) => new((int)(v.X * scalar), (int)(v.Y * scalar));
        public static Vector2Int operator /(Vector2Int v, int scalar) => new(v.X / scalar, v.Y / scalar);
        public static Vector2Int operator /(Vector2Int v, float scalar) => new((int)(v.X / scalar), (int)(v.Y / scalar));
        public static Vector2Int operator *(Vector2Int a, Vector2Int b) => new(a.X * b.X, a.Y * b.Y);
        public static Vector2Int operator /(Vector2Int a, Vector2Int b) => new(a.X / b.X, a.Y / b.Y);
        public static bool operator ==(Vector2Int left, Vector2Int right) => left.X.Equals(right.X) && left.Y.Equals(right.Y);
        ...
        public static implicit operator Vector2D<int>(Vector2Int v) => new(v.X, v.Y);
        ...
        public static Vector2Int Lerp(Vector2Int value1, Vector2Int value2, float amount) => new((Vector2)value1 * (1.0f - amount) + (Vector2)value2 * amount);
        public static Vector2Int Max(Vector2Int value1, Vector2Int value2) => new(
            (value1.X > value2.X) ? value1.X : value2.X,
            (value1.Y > value2.Y) ? value1.Y : value2.Y
        );
        public static Vector2Int Min(Vector2Int value1, Vector2Int value2) => new(
                (value1.X < value2.X) ? value1.X : value2.X,
                (value1.Y < value2.Y) ? value1.Y : value2.Y
        );
        public static Vector2Int Sqrt(Vector2Int value) => new((int)Math.Sqrt(value.X), (int)Math.Sqrt(value.Y));
